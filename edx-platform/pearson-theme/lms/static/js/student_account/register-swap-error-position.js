...
function initMessageCopyObserver() {
  ...
  /**
   * Replaces the default registration error title for You're almost there.
   */
  function updateRegisterErrorTitle() {
    var $title = $('#register-form > div.js-form-feedback > div.js-form-errors.status.submission-error > h4');
